...
<div id="content" class="p-4 p-md-5 pt-5">
     ...
     <br>
          ...
          $b1 =  $etabliss[1]->etabliss_id;
          $b = DB::table('etablissements')->where('id','=',$b1)->get();
          foreach ($b as $n1){
              $l1 = $n1->nom;
          }

          $c1 =  $etabliss[2]->etabliss_id;
