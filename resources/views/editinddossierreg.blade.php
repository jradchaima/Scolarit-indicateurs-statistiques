...
<html lang="en">
 ...
 <meta charset="utf-8">
  ...
  <body>
        ...
        <form action="{{ url('dossierreg-update/'.$dossiermedical->id)}}"   method="post">
        {{csrf_field()}}
        {{ method_field('PUT')}}
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text"  name="id_etabl"class="form-control" value="{{ $dossiermedical->id_etabl }}">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">id_centrale</label>
            <input type="text"  name="id_centrale"class="form-control" value="{{ $dossiermedical->id_centrale }}">
          </div>
        
        
      <div class="modal-footer">
        <a href="{{url('/layouts/inddossierreg')}}"  class="btn btn-secondary" >BACK</a>
