  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="/saveensgreg"   method="post">
        {{csrf_field()}}
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text"   name="id_centrae" class="form-control" id="recipient-name">
          </div>
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_absensegreg">
    ...
    <br> </br>
    <h3 style="text-align:center;margin-left:5%;margin-bottom:-5%;">&ensp; &ensp; &ensp; Liste des abscences</h3>
...
<br> </br><br> </br>
 ...
 <table id="table1" class="table">
  <thead class="thead-dark">
    <tr>
      <th scope="col">ID</th>
      <th scope="col">nb_abs</th>
      <th scope="col">nbj_abs</th>
    
      <th scope="col">type_abs</th>
...
@foreach ($absenceenseg as $data)
    <tr>
      ...
      <td><a href="{{ url('absensgreg-edit/'.$data->id)}}" class="btn btn-success">EDIT  </a>          </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_absensegreg').val(data[0]);
    $('#delete_model_form').attr('action','/absensgreg-delete/'+data[0]);
