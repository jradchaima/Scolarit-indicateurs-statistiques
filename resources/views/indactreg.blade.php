  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">New Activite</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      
        <form action="/saveactreg"   method="post">
        {{csrf_field()}}
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_activitereg">
 ...
 <table id="table1" class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">nb_activite</th>
    
      <th scope="col">nb_eleve</th>
...
@foreach ($activite as $data)
    <tr>
      ...
      <td><a href="{{ url('actreg-edit/'.$data->id)}}" class="btn btn-success">EDIT  </a>          </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_activitereg').val(data[0]);
    $('#delete_model_form').attr('action','/actreg-delete/'+data[0]);
