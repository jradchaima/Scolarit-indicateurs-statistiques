  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="/saveensg"   method="post">
        {{csrf_field()}}
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Nombre jours abscences</label>
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_absenseg">
    ...
    <br> </br>
    <h3 style="text-align:center;margin-left:5%;margin-bottom:-5%;">&ensp; &ensp; &ensp; Liste des abscences enseignants</h3>
...
<br> </br><br> </br>
 ...
 <table id="table1" class="table">
  <thead class="thead-dark">
    <tr>
      <th scope="col">ID</th>
      <th scope="col">Nombre abscence</th>
...
@foreach ($absenceenseg as $data)
    <tr>
      ...
      <td><a href="{{ url('absensg-edit/'.$data->id)}}" class="btn btn-success">EDIT  </a>          </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_absenseg').val(data[0]);
    $('#delete_model_form').attr('action','/absensg-delete/'+data[0]);
