  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="/savedossierreg"   method="post">
        {{csrf_field()}}
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_dossreg">
    ...
    <br> </br>
    <h3 style="text-align:center;margin-left:5%;margin-bottom:-5%;">&ensp; &ensp; &ensp; Liste des dossiers </h3>
...
@foreach ($dossiermedical as $data)
    <tr>
      ...
      <td><a href="{{ url('dossierreg-edit/'.$data->id)}}" class="btn btn-success">EDIT  </a>          </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_dossreg').val(data[0]);
    $('#delete_model_form').attr('action','/dossierreg-delete/'+data[0]);
