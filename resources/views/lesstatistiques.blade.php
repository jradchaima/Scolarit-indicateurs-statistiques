  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-red w3-padding-16" style="width:80%">
        ...
        <a href="/layouts/absensegstat"><h4>Absences Enseignants</h4></a>
      </div>
    </div>
    <div class="w3-quarter" >
      <div class="w3-container w3-blue w3-padding-16" style="width:80%">
        ...
        <div class="w3-clear"></div>
        <a href="/layouts/abselevestat"><h4>Absences Eleves</h4></a>
      </div>
    </div>
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-teal w3-padding-16"style="width:80%">
        ...
        <div class="w3-clear"></div>
        <a href="/layouts/activitestat"> <h4>Activités culturels </h4></a>
      </div>
    </div>
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-orange w3-text-white w3-padding-16"style="width:80%">
        ...
        <div class="w3-clear"></div>
        <a href="/layouts/communicationstat"><h4>Communications</h4></a>
      </div>
    </div>
  </div>
<br><br>
  <div class="w3-quarter">
      <div class="w3-container w3-red w3-padding-16" style="width:80%">
        ...
        <h3><?php 
         ...
         <div class="w3-clear"></div>
        <a href="/sancstat"><h4>Sanctions</h4></a>
      </div>
    </div>
    <div class="w3-quarter" >
      <div class="w3-container w3-blue w3-padding-16" style="width:80%">
