...
$a = DB::table('communications')->where([
    ['id_centrale', '=', $l],
    ['type_comun','=' ,$m],])->distinct('id_region')->count('id_region');
    echo $a;
         ?>
         </td>
         </tr>
...
<?php 
         ...
         $a1 = DB::table('communications')->where([
             ['id_centrale', '=', $l],
             ['type_comun','=' ,$m1],])->distinct('id_region')->count('id_region');
             echo $a1;             
         ?>
      </td>
