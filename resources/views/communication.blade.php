  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="/savecomun"   method="post">
        {{csrf_field()}}
        <div class="modal-body">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">type_comunication</label>
            <input type="text" name="type_comun" class="form-control" id="recipient-name">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">nombre_comunication</label>
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_comunication">
...
<br> </br><br> </br>
 ...
 <table id="table1" class="table">
  <thead class="thead-dark">
    <tr>
      <th scope="col">ID</th>
      <th scope="col">type_communication</th>
      <th scope="col">nombre_communication</th>
...
@foreach ($communication as $data)
    <tr>
      ...
      <td><a href="{{ url('comun-edit/'.$data->id)}}" class="btn btn-success">EDIT  </a>          </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_comunication').val(data[0]);
    $('#delete_model_form').attr('action','/comun-delete/'+data[0]);
