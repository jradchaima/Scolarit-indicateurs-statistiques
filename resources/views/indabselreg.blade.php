  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="/saveelevereg"   method="post">
        {{csrf_field()}}
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_abselevereg">
...
@foreach ($absenceeleve as $data)
    <tr>
      ...
      <td><a href="{{ url('abselevereg-edit/'.$data->id)}}" class="btn btn-success">EDIT  </a>          </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_abselevereg').val(data[0]);
    $('#delete_model_form').attr('action','/abselevereg-delete/'+data[0]);
