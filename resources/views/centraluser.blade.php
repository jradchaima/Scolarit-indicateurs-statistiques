  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nouvelle direction centrale</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
     
        <form action="/savecentral"   method="post">
        {{csrf_field()}}
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text"   name="email" class="form-control" id="recipient-name2">
            @error('email')<div class="text-danger">{{ $message }}</div> @enderror
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Mot de passe</label>
            <input type="password"   name="password" class="form-control" id="recipient-name3">
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_centraluser">
    ...
    <br> </br>
    <h3 style="text-align:center;margin-left:5%;margin-bottom:-5%;">&ensp; &ensp; &ensp; Liste des directions centrales</h3>
...
@foreach ($centraluser as $data)
    <tr>
      ...
      <td><a href="{{ url('centrale-edit/'.$data->id)}}" class="btn btn-success">EDIT</a>  </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_centraluser').val(data[0]);
    $('#delete_model_form').attr('action','/centrale-delete/'+data[0]);
