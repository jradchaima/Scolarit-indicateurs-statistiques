  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nouvelle abscence</h5>
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Nombre abscences</label>
            <input type="text" name="nb_abs" class="form-control" id="recipient-name">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Nombre jours</label>
            <input type="text"   name="nbj_abs" class="form-control" id="recipient-name">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Types abscences</label>
            <input type="text"   name="type_abs" class="form-control" id="recipient-name">
          </div>
		
		  <div class="form-group">
            <label for="recipient-name" class="col-form-label">Niveau</label>
            <input type="text"   name="niveau" class="form-control" id="recipient-name">
          </div>
...
<div class="modal fade" id="deletemodelpop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="delete_abseleve">
    ...
    <br> </br>
    <h3 style="text-align:center;margin-left:5%;margin-bottom:-5%;">&ensp; &ensp; &ensp; Liste des abscences élèves</h3>
 ...
 <table id="table1" class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Nombre jours abscences</th>
    
      <th scope="col">Type Abscence</th>
...
@foreach ($absenceeleve as $data)
    <tr>
      ...
      <td><a href="{{ url('abseleve-edit/'.$data->id)}}" class="btn btn-success">EDIT  </a>          </td>
...
$(document).ready( function () {
   ...
   console.log(data);
    $('#delete_abseleve').val(data[0]);
    $('#delete_model_form').attr('action','/abseleve-delete/'+data[0]);
