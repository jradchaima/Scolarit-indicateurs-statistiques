  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-red w3-padding-16" style="width:80%">
        ...
        <a href="/layouts/absensstatcnte"><h4>Absences Enseignants</h4></a>
      </div>
    </div>
    <div class="w3-quarter" >
      <div class="w3-container w3-blue w3-padding-16" style="width:80%">
        ...
        <div class="w3-clear"></div>
        <a href="/layouts/abselevestatcente"><h4>Absences Eleves</h4></a>
      </div>
    </div>
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-teal w3-padding-16"style="width:80%">
        ...
        <div class="w3-clear"></div>
        <a href="/layouts/activstatcnte"> <h4>Activités culturels </h4></a>
      </div>
    </div>
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-orange w3-text-white w3-padding-16"style="width:80%">
        ...
        <div class="w3-clear"></div>
        <a href="/layouts/comunstatcnte"><h4>Communications</h4></a>
      </div>
    </div>
  </div>
<br><br>
